...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[placeholder]:text-muted-foreground/80 disabled:cursor-not-allowed disabled:opacity-50",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 font-mono text-[0.6875rem] uppercase tracking-wider text-muted-foreground",
      className,
    )}
    {...props}
  />
